...
function getMyTickets($maxval,$calCnt)
{
	...
	if($adb->num_rows($tktresult))
	{
		...
		$search_qry = "&query=true&Fields0=".$table_prefix."_troubletickets.status&Condition0=n&Srch_value0=closed&Fields1=".$table_prefix."_crmentity.smownerid&Condition1=c&Srch_value1=".$current_user->column_fields['user_name']."&searchtype=advance&search_cnt=2&matchtype=all"; // crmv@157122
...
function getParentLink($parent_id)
{
	...
	$parent_module =  getSalesEntityType($parent_id); //crmv@171021
