...
function module_Chart_HomePageDashboard($userinfo) {
	...
	global $showfullusername; // crmv@169701
	...
	$focusUsers = CRMEntity::getInstance('Users'); // crmv@169701
	...
	foreach($module_list as $modulename) {
		if(isset($modrecords[$modulename])) {
			...
			if($modrec_count > 0) {
				...
				$username = $focusUsers->formatUserName($user_id,$user_info,$showfullusername);
...
$sHTML .= "<tr>
	 ...
	 {		 
		...
		<tr>
			...
			<td class='dash_switch'><a href='#top'><img align='absmiddle' src='". resourcever('dash_scroll_up.jpg')."' border='0'></a></td>
		</tr>
		</table>";
	 }	
	$sHTML .="</td>
