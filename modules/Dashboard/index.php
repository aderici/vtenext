...
<table border=0 cellspacing=0 cellpadding=0 width=98% align=center>
     <tr>
        <td valign=top><img src="<?php echo resourcever('showPanelTopLeft.gif') ?>"></td>
		...
		<td width="100%">
			...
			<tr>
				...
				<!-- TOP SELECT OPTION -->
					...
					<tr>
						<td class="dash_border" width="1%"><img src="<?php echo resourcever('dash_screw.gif') ?>" border="0" align="absmiddle"></td>
					...
					<tr>
						...
						<td colspan="3">
							<table width="100%" border="0" cellpadding="0" cellspacing="0">
								<tr>
									<td width="112"><img src="<?php echo resourcever('dash_btm_left.jpg') ?>" border="0" align="absmiddle"></td>
									<td width="100%" class="dash_btm">&nbsp;</td>
									<td width="129"><img src="<?php echo resourcever('dash_btm_right.jpg') ?>" border="0" align="absmiddle"></td>
								</tr>
							</table>
						</td>
...
<td valign=top><img src="<?php echo resourcever('showPanelTopRight.gif') ?>"></td>
   </tr>
</table>
...
{
	jQuery('#dashChart').fadeOut(); // crmv@168103
	...
	jQuery.ajax({
		...
		success: function(result) {
			jQuery("#dashChart").html(result).hide();
			// crmv@168103
			setTimeout(function() {
				jQuery('#dashChart').fadeIn();
			}, 500);
			// crmv@168103e
			jQuery("#dashTitle_div").html(oCombo.options[oCombo.selectedIndex].text);
		}
	});	
	// crmv@192033e
}
