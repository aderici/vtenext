	...
	function vtlib_handler($moduleName, $eventType) {
		...
		global $adb, $table_prefix;
 		...
 		if($eventType == 'module.postinstall') {
			...
			Vtiger_Link::addLink($accModuleInstance->id, 'DETAILVIEWBASIC', 'TITLE_COMPOSE_FAX', "javascript:fnvshobj(this,'sendfax_cont');sendfax('\$MODULE\$','\$RECORD\$');", '', 1, $linkCondition); // crmv@180638
