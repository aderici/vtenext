...
function getNewLeads($maxval,$calCnt)
{
	...
	$search_qry = "&query=true&Fields0=".$table_prefix."_leaddetails.leadstatus&Condition0=n&Srch_value0=Lost+Lead&Fields1=".$table_prefix."_leaddetails.leadstatus&Condition1=n&Srch_value1=Junk+Lead&Fields2=".$table_prefix."_crmentity.smownerid&Condition2=e&Srch_value2=".$current_user->column_fields['user_name']."&Fields3=".$table_prefix."_crmentity.createdtime&Condition3=h&Srch_value3=".$start_date."&searchtype=advance&search_cnt=4&matchtype=all"; // crmv@157122
