...
class RecoverPwd {
	...
	public function displayMainForm($smarty) {
		...
		$description = '<form action="" onSubmit="if(checkRecoverForm()){ VtigerJS_DialogBox.block(); } else { return false; }" method="POST">
	...
	public function displayRecover($smarty, $key) {
		...
		$description = '
		<form action="" onsubmit="VtigerJS_DialogBox.block();" name="ChangePassword" method="POST">
		<input type="hidden" name="__csrf_token" value="'.RequestHandler::getCSRFToken().'"> 
	...
	public function displayChangeOldPwd($smarty, $key) {
		...
		$current_user->id = $user_id;
		$description = '
		<form action="" onsubmit="VtigerJS_DialogBox.block();" name="ChangeOldPassword" method="POST">
			<input type="hidden" name="__csrf_token" value="'.RequestHandler::getCSRFToken().'"> 
