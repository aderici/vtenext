...
class AutoUpdater {
	...
	public function createTables() {
		...
		if(!Vtiger_Utils::CheckTable($this->statuses_table)) {
			$schema = '<?xml version="1.0"?>
						<schema version="0.3">
		...
		if(!Vtiger_Utils::CheckTable($this->remind_table)) {
			$schema = '<?xml version="1.0"?>
						<schema version="0.3">
		...
		if(!Vtiger_Utils::CheckTable($this->seen_table)) {
			$schema = '<?xml version="1.0"?>
						<schema version="0.3">
	...
	public function statusHandler() {
		...
		if (array_key_exists($status, $this->status_timeouts)) {
			...
			if ($duration & $duration > $timeinfo['timeout']) {
				$goto = $timeinfo['goto'];
