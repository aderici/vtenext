...
if (!isModuleInstalled('JobOrder')) {
	...
	$fields = array();
	$fields[] = array('module'=>'ProjectPlan','block'=>'LBL_PROJECT_INFORMATION','name'=>'joborderid','label'=>'Job Order','uitype'=>'10','columntype'=>'I(19)','typeofdata'=>'V~O','quickcreate'=>'2','masseditable'=>'0','relatedModules'=>array('JobOrder'));
