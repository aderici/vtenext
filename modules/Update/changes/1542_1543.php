...
Update::info("The use of the session variable has been centralized in the class VteSession.");
Update::info("If you had customizations using the raw variable \$_SESSION,");
Update::info("please replace them with the proper methods (get and set) in the VteSession class,");
Update::info("otherwise the values may not be saved in the session.");
Update::info("See the file include/VteSession.php for a list of supported methods.");
Update::info("");
