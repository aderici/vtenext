...
if (!isModuleInstalled('Processes')) {
	require_once('vtlib/Vtiger/Package.php');
	$package = new Vtiger_Package();
	$package->importByManifest('Processes');
} else {
	Update::warn('Module Processes is already installed. Please remove it and install the new one.');
	Update::warn('');
}
...
$trans = array(
	'ALERT_ARR' => array(
		'it_it' => array(
			...
			'LBL_PMH_SELECT_RELATED_TO'=>'Seleziona un\'entit� collegata al Process Helper oppure disattivalo',
			'LBL_PM_CHECK_ACTIVE'=>'Il processo non � ancora attivo. Vuoi attivarlo adesso?',
		),
		'en_us' => array(
	...
	'Settings' => array(
		'it_it' => array(
			...
			'LBL_EXCLUSIVEGATEWAY_SUCCESS'=>'Se la condizione precedente � soddisfatta vai a',
			'LBL_EXCLUSIVEGATEWAY_OTHER'=>'altrimenti vai a',
			'LBL_PM_ACTION_Email'=>'Email',
			'LBL_PM_ACTION_Create'=>'Crea entit�',
			'LBL_PM_ACTION_Update'=>'Aggiorna entit�',
			'LBL_PM_ACTION_Delete'=>'Elimina entit�',
			...
			'LBL_PMH_CURRENT_ENTITY'=>'Entit� corrente',
			...
			'LBL_PROCESS_MAKER_MANAGE_OTHER_RECORD' => 'Gestisci altre entit� nel processo',
			...
			'LBL_PM_WAIT'=>'Attendi',
			'LBL_PM_AFTER'=>'Se il processo resta fermo in questo per pi� di',
			...
			'LBL_PM_START_EVENT_NOTE'=>'Configurando le condizioni temporali e impostando il flag Attivo nel Process manager il processo sar� schedulato. Baster� modificare i seguenti parametri per rischedularlo.',
			'LBL_PM_SUBPROCESSES'=>'Sottoprocessi',
			'LBL_PM_CHECK_TIMER_START_DATE'=>'Non � permesso impostare un timer di partenza con orario passato',
