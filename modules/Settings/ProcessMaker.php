...
switch($mode) {
	...
	case 'modeler':
		...
		<div style="float:right; padding-right:5px" class="processes_btn_div">
			<input type="button" id="save-button" class="crmbutton small edit" value="'.$app_strings['LBL_SAVE_LABEL'].'" title="'.$app_strings['LBL_SAVE_LABEL'].'"></input>
			<input type="button" onclick="window.location.href=\'index.php?module=Settings&action=ProcessMaker\'" class="crmbutton small edit" value="'.$mod_strings['LBL_CANCEL_BUTTON'].'" title="'.$mod_strings['LBL_CANCEL_BUTTON'].'"></input>
			<img id="logo" src="'.get_logo('header').'" alt="{$APP.LBL_BROWSER_TITLE}" title="'.$app_strings['LBL_BROWSER_TITLE'].'" border=0 style="padding:1px 0px 3px 0px; max-height:34px">
		</div>';
