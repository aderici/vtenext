...
class Vtiger_MailBox {
	...
	function connect($folder='INBOX') {
		...
		Vtiger_MailScanner::performanceLog("Imap connection", 'imap_connection'); // crmv@170905
		...
		Vtiger_MailScanner::performanceLog("Imap connection in {tac}", 'imap_connection', true); // crmv@170905
	...
	function getMessage($messageid, $fetchbody=true) {
		return new Vtiger_MailRecord($this->_imap, $this->_imapfolder, $messageid, $fetchbody, $this->_mailboxsettings['is_pec']);	//crmv@56233 crmv@178441
	}
