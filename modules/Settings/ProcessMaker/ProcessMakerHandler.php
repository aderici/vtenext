...
class ProcessMakerHandler extends VTEventHandler {
	...
	function handleEvent($eventName, $entityData) {
		...
		if (in_array($entityData->getModuleName(),$PMUtils->modules_not_supported)) return false;
		//crmv@OPER10174e
		...
		// check start events
		($isNew) ? $nextEvents = array() : $nextEvents = $PMUtils->getNextEvents($entity_id, $moduleName, $this->parallel_current_info); //crmv@115579 crmv@171524
