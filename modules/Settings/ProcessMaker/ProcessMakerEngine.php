...
class ProcessMakerEngine extends SDKExtendableClass {
	...
	function executeCondition($bpmnType) {
		...
		$processMakerHandler->handleEvent('vtiger.entity.aftersave.processes', $entityData); // crmv@177677
	}
	...
	// crmv@102879
	function replaceTags($fieldname,$value,$referenceFields,$ownerFields,$actionid=false,$cycleIndex=null,$advanced_field_condition=false,$prepareValue=true) {	//crmv@106856 crmv@177561
