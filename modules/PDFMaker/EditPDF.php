...
echo '<html>
      ...
      <link rel="stylesheet" href="themes/'.VteSession::get("vtiger_authenticated_user_theme").'/style.css">
      </head>
      <body leftmargin=0 topmargin=0 marginheight=0 marginwidth=0>';	//crmv@25443
      
      if(VteSession::hasKey("VTIGER_DB_VERSION") AND VteSession::get("VTIGER_DB_VERSION") == "5.1.0"){
