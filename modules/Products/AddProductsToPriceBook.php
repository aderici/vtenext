...
$other_text = '
	...
	if($num_rows != $num_prod_rows && $num_rows > 0)
	        $other_text .='<input class="crmbutton small save" type="submit" value="'.$mod_strings['LBL_ADD_PRODUCTS_PRICEBOOK'].'" onclick="return addtopricebook()"/>';
