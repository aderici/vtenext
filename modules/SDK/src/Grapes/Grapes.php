...
$smarty->assign('UP_ENDPOINT', $site_URL.'/include/ckeditor/filemanager/connectors/php/filemanager.php');
...
foreach ($allOptions as $mod => &$fields) {
	foreach ($fields as &$f) {
		$f[0] = addslashes($f[0]);
		$f[1] = addslashes($f[1]);
	}
