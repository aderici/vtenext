...
Vtiger_MailScanner::performanceLog("Starting mailscanner service", 'mailscanner_service'); // crmv@170905
...
function service_MailScanner_performScanNow($scannerinfo, $debug) {
	...
	if($scannerinfo->isvalid) {
		...
		Vtiger_MailScanner::performanceLog("Scanning " . $scannerinfo->scannername. " in progress", 'mailscanner_server'); // crmv@170905
		...
		Vtiger_MailScanner::performanceLog("Scanning " . $scannerinfo->scannername. " completed in {tac}", 'mailscanner_server', true); // crmv@170905
...
Vtiger_MailScanner::performanceLog("Mailscanner service finished in {tac}", 'mailscanner_service', true); // crmv@170905
