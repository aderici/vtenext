...
function to_html($string, $encode=true)
{
	...
	if(is_string($string))
	{
		if($action != 'CustomView' && $action != 'Export' && $action != $ajax_action && $action != 'LeadConvertToEntities' && $action != 'CreatePDF' && $action != 'CreatePDFFromTemplate' && $action != 'ConvertAsFAQ' && $module != 'Dashboard' && $action != 'CreateSOPDF' && $action != 'SendPDFMail' ) // crmv@104506 crmv@188369
		{
			$doconvert = true;
		}
		else if($search == true)
