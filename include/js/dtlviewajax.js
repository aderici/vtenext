...
/**
 * @deprecated
 * This function has been moved to VTE.TagCloud class.
 */

function tagvalidate() {
	return VTE.callDeprecated('tagvalidate', VTE.TagCloud.tagvalidate, arguments);
}
...
function DeleteTag(id, recordid) {
	return VTE.callDeprecated('DeleteTag', VTE.TagCloud.DeleteTag, arguments);
}
...
function getTagCloud() {
	return VTE.callDeprecated('getTagCloud', VTE.TagCloud.getTagCloud, arguments);
}
...
function SaveTag(tagfield, crmId, module) {
	return VTE.callDeprecated('SaveTag', VTE.TagCloud.SaveTag, arguments);
}
