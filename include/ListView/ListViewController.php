...
class ListViewController extends SDKExtendableClass {
	...
	function getMoreInformationsDiv($recordId,$fieldName,$moreInformations) {
		$value = '&nbsp;<a href="javascript:;"><i class="vteicon md-sm valign-bottom" onmouseout="jQuery(\'#content_'.$fieldName.'_'.$recordId.'\').hide();" onmouseover="jQuery(\'#content_'.$fieldName.'_'.$recordId.'\').show();checkDivPosition(jQuery(\'#content_'.$fieldName.'_'.$recordId.'\'));">chat</i></a>
