	...
	function addEntriesForSettings(){
		...
		$allSettings = array(
			...
			'LBL_KLONDIKE_AI' => array(
				'fields' => array(
					array('name' => 'LBL_KLONDIKE_CLASSIFIER', 'iconpath' => 'gavel', 'description' => 'LBL_KLONDIKE_CLASSIFIER_DESC', 'linkto' => 'index.php?module=Settings&action=KlondikeClassifier&parenttab=Settings', 'sequence' => '1', 'active' => '0'),
					array('name' => 'LBL_PROCESS_DISCOVERY_AGENT', 'iconpath' => 'gavel', 'description' => 'LBL_PROCESS_DISCOVERY_AGENT_DESC', 'linkto' => 'index.php?module=Settings&action=ProcessDiscoveryAgent&parenttab=Settings', 'sequence' => '2', 'active' => '0'),
					array('name' => 'LBL_PROCESS_DISCOVERY', 'iconpath' => 'call_split', 'description' => 'LBL_PROCESS_DISCOVERY_DESC', 'linkto' => 'index.php?module=Settings&action=ProcessDiscovery&parenttab=Settings', 'sequence' => '3', 'active' => '0'),
				),
				'image' => 'gavel',
			),
