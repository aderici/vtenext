				...
				<tr>
					...
					<td class="mailClientBg" style="padding-left:10px;padding-top:10px;vertical-align:top;">
						<table width="100%"  border="0" cellpadding="5" cellspacing="0" class="small">
					   		<tr>
								<td width="10%"><img src="{'migrate.gif'|resourcever}" align="absmiddle"/></td>
								<td width="90%">
...
<!--							<tr>
							...
							<tr>
								<td colspan="2" align="center">
									<table width="40%" cellpadding="0" cellspacing="5" style="border: 1px solid #777;">
										...
										<tr><th>{$CONFIG_CHARSET}
											{if $CONFIG_STATUS eq '1'} <img src="{'yes.gif'|resourcever}" /> 
											{else} <img src="{'no.gif'|resourcever}" /> 
											{/if}
											</th>
											<th>{$DB_CHARSET}
												{if $DB_STATUS eq '1'} <img src="{'yes.gif'|resourcever}" /> 
												{else} <img src="{'no.gif'|resourcever}" /> 
												{/if}
											</th>
										</tr>
							...
							<tr>
	           					<td colspan="2" align="center">
						            <img src="{'no.gif'|resourcever}" /> Not recommended setting for UTF-8 Support. &nbsp;
						            <img src="{'yes.gif'|resourcever}" /> Meets recommended setting for UTF-8 Support.
					           </td>
					        </tr>
