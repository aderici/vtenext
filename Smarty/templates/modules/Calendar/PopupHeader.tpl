			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				<tr>
					...
					<td width="50%" align="right">
						<input id="btnDetail" class="crmbutton edit" type="button" value="{$APP.LBL_SHOW_DETAILS}"></input>
						<input id="btnEdit" class="crmbutton edit success" type="button" value="{$MOD.LBL_EDIT}"></input>
						<input id="btnCloseActivity" class="crmbutton save" type="button" value="{$MOD.LBL_LIST_CLOSE} {$APP.Activity}"></input>
