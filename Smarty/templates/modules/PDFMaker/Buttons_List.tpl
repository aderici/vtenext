			...
			<!-- Calendar Clock Calculator and Chat -->
				...
				<tr>
                    ...
                    {if $CALCULATOR_DISPLAY eq 'true'} 
                        <td style="padding-right:0px"><a href="#"><img src="{'btnL3Calc.gif'|resourcever}" alt="{$APP.LBL_CALCULATOR_ALT}" title="{$APP.LBL_CALCULATOR_TITLE}" border=0 onClick="fnvshobj(this,'calculator_cont');fetch_calc();"></a></td> 
                    {/if} 
