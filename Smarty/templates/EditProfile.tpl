...
<tbody><tr>
	...
	<div align=center>
			...
			{include file='Buttons_List.tpl'} {* crmv@30683 *}
				<!-- DISPLAY -->
				<form action="index.php" method="post" name="profileform" id="form" onsubmit="if (countFormVars('form','form_var_count')) VtigerJS_DialogBox.block(); else return false;">	{* crmv@111926 *}
