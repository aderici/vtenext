...
<tbody><tr>
	...
	<div align=center>
				...
				{literal}
				<form action="index.php" method="post" name="profileform" id="form" onSubmit="if(ProfileUtils.rolevalidate('{$MOD.LBL_ENTER_PROFILE}')) { VtigerJS_DialogBox.block();return true;}else{return false;}">
				{/literal}
