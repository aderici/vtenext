																				...
																				<td colspan="3" nowrap>
																					<div id="date_start_adv_options" style="display:none">
																						...
																						<div style="float:left; padding-right:10px">
																							<i class="vteicon md-link" title="{'LBL_SELECT_OPTION_DOTDOTDOT'|getTranslatedString:'com_vtiger_workflow'}" id="date_start_opt_num_editoptions_more" onclick="ActionTaskScript.toggleFieldEditOptions('date_start_opt_num')">more_horiz</i>
																						</div>
																...
																<tr>
																	<td colspan="2" nowrap>
																		<div id="time_start_adv_options" class="dvtCellInfo" style="display:none">
																			...
																			<div style="float:left; padding-right:10px">
																				<i class="vteicon md-link" title="{'LBL_SELECT_OPTION_DOTDOTDOT'|getTranslatedString:'com_vtiger_workflow'}" id="time_start_opt_num_editoptions_more" onclick="ActionTaskScript.toggleFieldEditOptions('time_start_opt_num')">more_horiz</i>
																			</div>
																			<div style="float:left; width:30%; padding-right:10px">
																				...
																				<tr>
																					<td colspan="3" nowrap>
																						<div id="due_date_adv_options" style="display:none">
																							...
																							<div style="float:left; padding-right:10px">
																								<i class="vteicon md-link" title="{'LBL_SELECT_OPTION_DOTDOTDOT'|getTranslatedString:'com_vtiger_workflow'}" id="due_date_opt_num_editoptions_more" onclick="ActionTaskScript.toggleFieldEditOptions('due_date_opt_num')">more_horiz</i>
																							</div>
																							<div style="float:left; width:30%; padding-right:10px">
																	...
																	<tr>
																		<td colspan="2" nowrap>
																			<div id="time_end_adv_options" class="dvtCellInfo" style="display:none">
																				...
																				<div style="float:left; padding-right:10px">
																					<i class="vteicon md-link" title="{'LBL_SELECT_OPTION_DOTDOTDOT'|getTranslatedString:'com_vtiger_workflow'}" id="time_end_opt_num_editoptions_more" onclick="ActionTaskScript.toggleFieldEditOptions('time_end_opt_num')">more_horiz</i>
																				</div>
																				<div style="float:left; width:30%; padding-right:10px">
