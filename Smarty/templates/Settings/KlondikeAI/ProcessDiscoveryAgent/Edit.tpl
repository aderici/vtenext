...
<br>
<form method="POST" action="index.php" onsubmit="VtigerJS_DialogBox.block();">
		...
		<tr>
			...
			<td align="left" width="250">
				<div class="dvtCellInfo" style="float:left">
					<select name="moduleName" class="dvtCellInfo detailedViewTextBox" onchange="loadFilter(this.value)">
...
function loadFilter(module) {
	jQuery.ajax({
		'url': 'index.php?module=Settings&action=SettingsAjax&file=ProcessDiscoveryAgent&mode=view&moduleName='+module,
		success: function(data) {
			jQuery('#viewname').html(data);
		}
	});
}
{/literal}
