	...
	<tbody>
		<tr>
			...
			<td class="showPanelBg" style="padding: 5px;" valign="top" width="100%"> <!-- crmv@30683 -->
				...
				{else}
					{literal}
					<form action="index.php" method="post" name="FaxServer" id="form" onsubmit="if (VTE.Settings.FaxConfig.validate_fax_server(FaxServer)) { VtigerJS_DialogBox.block(); return true; } else { return false; }">
					{/literal}		
