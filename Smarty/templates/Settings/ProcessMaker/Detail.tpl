...
(function(BpmnViewer) {
	...
	jQuery.get('index.php?module=Settings&action=SettingsAjax&file={/literal}{if $DISCOVERY_MODE}ProcessDiscovery{else}ProcessMaker{/if}{literal}&mode=download&format=bpmn&id={/literal}{$DATA.id}{literal}', importXML, 'text'); // crmv@190834
