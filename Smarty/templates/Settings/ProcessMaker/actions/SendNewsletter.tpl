...
<table border="0" cellpadding="2" cellspacing="0" width="100%" class="small" style="padding-top:5px">
	...
	<tr>
		...
		<td>
			...
			<div class="dvtCellInfo" style="margin-left:5px; float:left">
				<span id="task-emailfields_sendername-busyicon"><b>{'LBL_LOADING'|getTranslatedString:'com_vtiger_workflow'}</b>{include file="LoadingIndicator.tpl"}</span>
	...
	<tr>
		...
		<td>
			...
			{/if}
			<div class="dvtCellInfo" style="margin-left:5px;float:left">
				<span id="task-emailfields_recipients-busyicon"><b>{'LBL_LOADING'|getTranslatedString:'com_vtiger_workflow'}</b>{include file="LoadingIndicator.tpl"}</span>
