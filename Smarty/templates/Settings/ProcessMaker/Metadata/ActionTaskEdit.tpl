...
<form id="actionform" 
	...
	$ACTIONTYPE eq 'ModNotification' || $ACTIONTYPE eq 'CreatePDF' || $ACTIONTYPE eq 'InsertProductRow'}
		name="EditView"
	{else}
		name="actionform"
	{/if} method="post" onsubmit="VtigerJS_DialogBox.block();"> {* crmv@126696 crmv@160843 crmv@183346 crmv@187729 *}
	{* crmv@195745e *}
