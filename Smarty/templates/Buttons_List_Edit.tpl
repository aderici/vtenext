	 		...
	 		{if $smarty.request.module eq 'Calendar'}
	 			{if $ACTIVITY_MODE neq 'Task'}
					...
					{if $OP_MODE eq 'create_view' && !empty($RETURN_ID) && !empty($RETURN_MODULE)}
						...
						<input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accesskey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" name="button" value="{$APP.LBL_SAVE_BUTTON_LABEL}" onclick="this.form.return2detail.value='yes'; this.form.action.value='Save'; VtigerJS_DialogBox.block(); jQuery(this.form).submit();" type="button" />
					{else}
	 					<input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accesskey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" name="button" value="{$APP.LBL_SAVE_BUTTON_LABEL}" onclick="this.form.action.value='Save'; VtigerJS_DialogBox.block(); jQuery(this.form).submit();" type="button" />
	 				{/if}
	 			{else}
					{if $OP_MODE eq 'create_view' && !empty($RETURN_ID) && !empty($RETURN_MODULE)}
						<input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accesskey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton backButtonSave small" name="button" value="{$APP.LBL_SAVE_AND_BACK_BUTTON_LABEL}" onclick="this.form.action.value='Save'; VtigerJS_DialogBox.block(); jQuery(this.form).submit();" type="button" />
						<input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accesskey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" name="button" value="{$APP.LBL_SAVE_BUTTON_LABEL}" onclick="this.form.return2detail.value='yes'; this.form.action.value='Save'; VtigerJS_DialogBox.block(); jQuery(this.form).submit();" type="button" />
					{else}
	 					<input title="{$APP.LBL_SAVE_BUTTON_TITLE}" accesskey="{$APP.LBL_SAVE_BUTTON_KEY}" class="crmbutton small save" name="button" value="{$APP.LBL_SAVE_BUTTON_LABEL}" onclick="this.form.action.value='Save'; VtigerJS_DialogBox.block(); jQuery(this.form).submit();" type="button" />
	 				{/if}
