...
<head>
	...
	{if $INCLUDES == 'all' || in_array('icons', $INCLUDES)}
		...
		<link rel="manifest" href="{$RELPATH}themes/logos/icons/site.webmanifest">
		<link rel="mask-icon" href="{$RELPATH}themes/logos/icons/safari-pinned-tab.svg" color="#16556f">
		<link rel="shortcut icon" href="{$RELPATH}{'favicon'|get_logo}">
		<meta name="msapplication-TileColor" content="#16556f">
		<meta name="msapplication-config" content="{$RELPATH}themes/logos/icons/browserconfig.xml">
